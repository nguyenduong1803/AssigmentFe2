  ...
  return (
    ...
    <Grid container spacing={3}>
        <Grid item xs={12} md={6}>
          <ControlTextField id="outlined-basic" disabled label="Category ID" name="id" control={control} />
        </Grid>
        <Grid item xs={12} md={6}>
          <ControlTextField id="outlined-basic"  label="Category Name" name="category" control={control} />
        </Grid>
    </Grid>
